...
parseInput CommandMode [CmdAmount n] (Curses.EventCharacter '$') = ([], [matchAction [CmdAmount n, CmdEndOfLine]])
...
matchAction [CmdAmount n, CmdEndOfLine] = ActEndOfLine n 
matchAction [CmdEndOfLine] = ActEndOfLine 0
